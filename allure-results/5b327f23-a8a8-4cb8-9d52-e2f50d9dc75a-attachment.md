    ...
    - generic [ref=e18]:
      - generic [ref=e19]:
        ...
        - generic [ref=e30]:
          - generic [ref=e31]: "1"
          - generic [ref=e32]:
            - link "Sauce Labs Bolt T-Shirt" [ref=e33]:
              - /url: "#"
...
```ts
  ...
  106 | 
> 107 |     await expect(page.getByText("Sauce Labs Backpack")).toBeVisible();
      |                  ^ ReferenceError: page is not defined
  108 |     await expect(page.getByText("Sauce Labs Bolt T-Shirt")).toBeVisible();
  109 |     await expect(page.getByText("Sauce Labs Bike Light")).toBeVisible();
